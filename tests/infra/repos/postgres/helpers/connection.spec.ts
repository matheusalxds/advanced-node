...
describe('PgConnection', () => {
  ...
  test('should return ConnectionNotFoundError on commit if query runner is not found', async () => {
  ...
  test('should return ConnectionNotFoundError on rollback if query runner is not found', async () => {
